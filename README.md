...
Check out the latest milestone release tag (currently `release-M15.0`):

     git checkout -b [your-branch-name] release-M15.0
...
you have checked out the M15 release tag from this repository before you build,
